                                            ...
                                            <tbody>
                                                ...
                                                foreach ($sesiones as $m) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><span class="badge bg-primary"><?php echo $m->tipo; ?></span></td>
                                                        <td><?php echo date('Y-m-d H:i', strtotime($m->fecha . ' ' . $m->hora)); ?></td>
                                                        <th>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="#"><i class="fa-solid fa-trash"></i> Eliminar</a>
                                                                    <a class="dropdown-item" href="#"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                                                                </div>
                                                            </div>
