                                    ...
                                    <div class="container mt-5">
                                        ...
                                        <div class="text-center" style="margin-top: 20px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="titulo" readonly value="<?php echo $masterclass->titulo; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="titulo">Meet Id</label>
                                                <input type="text" class="form-control" id="session" readonly value="<?php echo $masterclass->session; ?>">
                                            </div>
                                            <div class="form-group">
